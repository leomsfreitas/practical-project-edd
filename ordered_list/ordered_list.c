...
1. Os pontos fortes de uma lista ordenada são a organização dos dados, que deixa tudo mais 
fácil de analisar, e a busca mais rápida, já que dá pra usar busca binária e economizar tempo. 
Por outro lado, os pontos fracos são o trabalho extra pra ordenar no começo, que pode ser demorado, 
e o custo alto pra inserir ou remover elementos, porque precisa reorganizar tudo pra manter a ordem.
